...
if entity @s[tag=coc.pact_formed]:
    ...
    as @a[distance=..16] if score @s coc.pact_id = $id coc.pact_id function ./show_eyes:
        positioned as @e[tag=coc.natural_rift,tag=coc.target,limit=1] positioned ~ ~1.5 ~ facing entity @s eyes function ./show_eyes/particles:
            particle dust 1 0.7 0 1 ^0.25 ^ ^1 0 0 0 0 1 force @s
            particle dust 1 0.7 0 1 ^-.25 ^ ^1 0 0 0 0 1 force @s
