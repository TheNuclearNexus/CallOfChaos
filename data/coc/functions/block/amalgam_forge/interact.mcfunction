...
anchored eyes function ./raycast:
    if block ^ ^ ^0.01 minecraft:furnace{Lock:"\\uf001coc.amalgam_forge"} positioned ^ ^ ^0.01 align xyz as @e[type=item_display,tag=coc.amalgam_forge,dx=0] positioned ~.5 ~ ~.5 function ./at_block:
