...
from typing import Any, Callable, ClassVar, Iterator, List, Literal, Protocol
from beet import Context
from beet.core.utils import required_field, extra_field
from bolt import Accumulator, AstInterpolation, Runtime
from mecha import (
    NUMBER_PATTERN,
    AlternativeParser,
    AstChildren,
...
from nbtlib import Base, Serializer as NbtSerializer, Compound
from tokenstream import InvalidSyntax, TokenStream, UnexpectedToken, set_location
